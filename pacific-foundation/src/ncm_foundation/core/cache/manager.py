"""Redis cache management and utilities (moved into cache package).

This module contains CacheManager and related helpers. It used to live at
`ncm_foundation.core.cache` (a module), but the package `ncm_foundation.core.cache`
now provides many cache submodules. To avoid a naming collision we place the
implementation here and re-export it from the package `__init__`.
"""
